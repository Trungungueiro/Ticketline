...
QT_MOC_LITERAL(3, 27, 18) // "on_Comprar_clicked"

    },
    "Pesquisar\0on_Sair_clicked\0\0"
    "on_Comprar_clicked"
};
...
void Pesquisar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Pesquisar *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_Sair_clicked(); break;
        case 1: _t->on_Comprar_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject Pesquisar::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_Pesquisar.data,
    qt_meta_data_Pesquisar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
